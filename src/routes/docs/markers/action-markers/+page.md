...
<img src="/show-timer.webp" alt="show-timer" />
...
<img src="/marker-action-rename.webp" alt="marker-action-renaming" />
...
<img src="/marker-play-noscroll.webp" alt="marker-play" />
...
2. Also, whatever the mode you're in (_prompting mode_ or not), you can always trigger any action marker by **right clicking** the marker's name and then select
   `Trigger Marker`
   <img src="/markers-right-click.jpg" alt="manual trigger" />
...
<img src="/show-caller-window.webp" alt="The Show-Caller support window" />
